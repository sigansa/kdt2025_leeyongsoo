...
public class ViewDialog extends JDialog {
    private BoardmapDto board;
    private BoardApp boardMain;
    ...
    public ViewDialog(BoardApp boardMain) {
        super(boardMain);
     ...
     * @param board
     */
    public void setBoard( BoardmapDto board) {
        this.board= board;
        txtTitle.setText(board.getTitle());
        txtWriter.setText(board.getAuthor());
        ...
        if(btnUpdate == null) {
            ...
            btnUpdate.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    board.setAuthor(txtWriter.getText());
                    board.setContent(txtContent.getText());
                    //boardMain.updateBoard(board);
